...
import { Github } from '@/components/GithubRepository'
  ...
  return (
    <>
      ...
      <Container className="md:mt-18 mt-16">
        ...
        <div className="mx-auto grid max-w-xl grid-cols-2 justify-between gap-y-4 pt-8 sm:grid-cols-2 md:grid-cols-4 lg:max-w-none">
          <div className="flex items-center">
            <SolidityIcon className="h-8 w-8 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300" />
            <p className="pl-2">Solidity</p>
          </div>
          <div className="flex items-center">
            <TypeScriptIcon className="h-8 w-8 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300" />
            <p className="pl-2">TypeScript</p>
          </div>
          <div className="flex items-center">
            <ReactIcon className="h-8 w-8 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300" />
            <p className="pl-2">React</p>
          </div>
          <div className="flex items-center">
            <NextIcon className="h-8 w-8 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300" />
